...
class WFACP_Public {
	...
	public function enqueue_script() {
		...
		if ( defined( 'BWF_DEV' ) ) {
			wp_enqueue_script( 'wfacp_track_checkout_js', plugin_dir_url( WFACP_PLUGIN_FILE ) . 'assets/js/native-tracks.js', [ 'jquery' ], WFACP_VERSION_DEV, true );
		} else {
			wp_enqueue_script( 'wfacp_track_checkout_js', plugin_dir_url( WFACP_PLUGIN_FILE ) . 'assets/js/native-tracks.min.js', [ 'jquery' ], WFACP_VERSION_DEV, true );
		}
	...
	public function is_native_checkout() {
		...
		if ( $post->post_status !== 'publish' || $post->post_type === WFACP_Common::get_post_type_slug() ) {
			return false;
		}
