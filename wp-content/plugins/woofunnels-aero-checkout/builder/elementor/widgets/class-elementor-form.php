...
class El_WFACP_Form_Widget extends WFACP_Elementor_HTML_BLOCK {
	...
	private function global_typography() {
		...
		$default_link_color_option = [
			'{{WRAPPER}} #wfacp-e-form .wfacp_main_form. .woocommerce-form-login-toggle .woocommerce-info a',
			'{{WRAPPER}} #wfacp-e-form .wfacp_main_form. a:not(.wfacp_close_icon):not(.button-social-login):not(.wfob_btn_add):not(.ywcmas_shipping_address_button_new):not(.wfob_qv-button):not(.wfob_read_more_link):not(.wfacp_step_text_have ):not(.wfacp_cart_link)',
			'{{WRAPPER}} #wfacp-e-form .wfacp_main_form. a span:not(.wfob_btn_text_added):not(.wfob_btn_text_remove)',
			'{{WRAPPER}} #wfacp-e-form .wfacp_main_form label a',
			'{{WRAPPER}} #wfacp-e-form .wfacp_main_form ul li a:not(.wfacp_breadcrumb_link)',
			'{{WRAPPER}} #wfacp-e-form .wfacp_main_form. table tr td a',
			'{{WRAPPER}} #wfacp-e-form .wfacp_main_form .wfacp_steps_sec ul li a',
			'{{WRAPPER}} #wfacp-e-form .wfacp_main_form. a.wfacp_remove_coupon',
		];
		...
		$default_link_hover_color_option = [
			...
			'{{WRAPPER}} #wfacp-e-form .wfacp_main_form ul li a:not(.wfacp_breadcrumb_link):hover',
	...
	private function collapsible_order_summary() {
		...
		$color_selector       = [
			'{{WRAPPER}} #wfacp-e-form .wfacp_mb_mini_cart_sec_accordion_content button.button.wfacp-coupon-btn',
		];
		$hover_color_selector = [
			'{{WRAPPER}} #wfacp-e-form .wfacp_mb_mini_cart_sec_accordion_content button.button.wfacp-coupon-btn:hover',
		];

		/* Button Background hover tab */
		$this->add_heading( __( 'Coupon Button Color', 'elementor' ) );
		$this->add_controls_tabs( "wfacp_collapsible_coupon_color_tab" );
		$this->add_controls_tab( "wfacp_collapsible_coupon_color_normal_tab", 'Normal' );
		$this->add_color( 'wfacp_collapsible_coupon_text_color', $color_selector, '', 'Color' );
		$this->add_background_color( 'wfacp_collapsible_coupon_background_color', $color_selector, "", 'Background Color' );
		$this->close_controls_tab();
		$this->add_controls_tab( "wfacp_collapsible_coupon_color_hover_tab", 'Hover' );
		$this->add_color( 'wfacp_collapsible_coupon_text_hover_color', $hover_color_selector, '', 'Color' );
		$this->add_background_color( 'wfacp_collapsible_coupon_background_hover_color', $hover_color_selector, "", 'Background Color' );
