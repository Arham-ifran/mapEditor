...
class WFACP_OXY_Form extends WFACP_OXY_HTML_BLOCK {
	...
	private function payment_buttons_styling( $tab_id ) {
		...
		$selector        = '#wfacp-e-form .wfacp_main_form.woocommerce .wfacp-next-btn-wrap button,#wfacp-e-form .wfacp_main_form.woocommerce #payment button#place_order,#wfacp-e-form .wfacp_main_form.woocommerce button#place_order';
		$button_selector = '#wfacp-e-form .wfacp_main_form.woocommerce #payment button#place_order,#wfacp-e-form .wfacp_main_form.woocommerce  button#place_order,#wfacp-e-form .wfacp_main_form.woocommerce .woocommerce-checkout button.button.button-primary.wfacp_next_page_button';
	...
	private function collapsible_order_summary( $tab_id ) {
		...
		$color_selector       = [
			'#wfacp-e-form .wfacp_mb_mini_cart_sec_accordion_content button.button.wfacp-coupon-btn',
		];
		$hover_color_selector = [
			'#wfacp-e-form .wfacp_mb_mini_cart_sec_accordion_content button.button.wfacp-coupon-btn:hover',
		];

		$this->add_heading( $tab_id, __( 'Coupon Button Color', 'elementor' ) );

		$this->add_color( $tab_id, 'wfacp_collapsible_coupon_text_color', implode( ',', $color_selector ), __( 'Text Color', 'woofunnels-aero-checkout' ) );
		$this->add_background_color( $tab_id, 'wfacp_collapsible_coupon_background_color', implode( ',', $color_selector ), "", 'Background Color' );


		$this->add_color( $tab_id, 'wfacp_collapsible_coupon_text_hover_color', implode( ',', $hover_color_selector ), __( 'Text Hover Color', 'woofunnels-aero-checkout' ) );
		$this->add_background_color( $tab_id, 'wfacp_collapsible_coupon_background_hover_color', implode( ',', $hover_color_selector ), "", __( 'Background Button Hover', 'woofunnels-aero-checkout' ) );
